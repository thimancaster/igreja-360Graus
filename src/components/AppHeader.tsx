...
export function AppHeader() {
  ...
  return (
    <header className="h-16 border-b border-white/10 glass-header sticky top-0 z-[40] overflow-visible">
      <div className="flex h-full items-center justify-between px-4 md:px-6 overflow-visible relative">
